 ...
 */
public class HashBasedTableStorage<R extends StorageObject, C extends StorageObject, V extends StorageObject> extends TableStorage<R, C, V, HashBasedTable<R, C, V>> {
    
    public HashBasedTableStorage(HashBasedTable<R, C, V> table) {
        super(table);
    }
    ...
    public StorageObject delegate() {
        return new HashBasedTableStorage(HashBasedTable.create(getValue()));
    }
}
